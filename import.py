...
import nltk
import ollama
from mattsollamatools import chunk_text_by_sentences, chunker
...
print(f"Counting existing collections: {chroma.count_collections()}")
print(f"Listing existing collection: {chroma.list_collections()}")
